...
このパートでは、StaticProcess-Tutorial1で作成したアプリケーションの変更を通じて、以下の機能を利用するための操作を学習します。
...
このハンズオンでは、StaticProcess-Tutorial1にて作成したプロセスを基に、ビジネスルールの追加などを実施していきます。最終的に、以下のプロセスを作成します。
...
1. 手順はStaticProcess-Tutorial1のアクティブ化と同様です。  
